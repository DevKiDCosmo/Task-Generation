...
def create_paper_json():
    ...
    tags = input("Enter tags (comma-separated, e.g., example,paper,template): ").strip().split(",") or ["example",
                                                                                                        "paper",
                                                                                                        "template"]
    ...
    while True:
        ...
        languages = input(f"Enter the languages for {exercise_id} (comma-separated, e.g., de,en,fr): ").strip().split(
            ",")
        versions = input(
            f"Enter the versions for {exercise_id} (comma-separated, matching the languages): ").strip().split(",")
