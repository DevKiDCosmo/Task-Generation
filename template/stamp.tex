...
{
\textit{This is an official examination application form.} \hfill \input{id}
}
...
\textbf{Submission Location:} __OFFICIAL__SUBMISSION_LOCATION__ \hfill \input{place} \\
...
\hfill%
\raisebox{-0.1\baselineskip}{\input{authsign.tex}}
...
\hfill%
\raisebox{-0.1\baselineskip}{\input{hash.tex}}
